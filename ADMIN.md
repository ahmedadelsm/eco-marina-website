...
SEO titles and descriptions are applied at **build time** via `buildPageMetadata` — redeploy after editing **Admin → SEO**. Dutch pages get `lang="nl"` in the exported HTML automatically during build.
